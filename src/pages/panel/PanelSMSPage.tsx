        ...
        <>
          ...
          >
            ...
            <ul className="min-h-0 flex-1 overflow-y-auto px-4 pb-6 pt-2">
              {items.map((item) => (
                <li key={item.id} className="border-b border-(--app-border)/60 py-3 last:border-0">
    ...
    >
      <div className="flex w-full justify-end px-3 pt-3">
        <button
          type="button"
          onClick={() => navigate('/app/home')}
          className="flex h-10 w-fit items-center justify-center gap-1.5 rounded-full border border-(--app-border) bg-(--white) px-3 text-(--teal-tertiary) transition hover:border-(--teal-primary)/35 hover:bg-(--app-gradient-start)"
          aria-label="بازگشت به لیست پنل‌ها"
        >
      ...
      <div className="mx-3 mt-3 shrink-0 rounded-3xl border border-(--app-border)/80 bg-(--surface-light)/95 px-4 pb-3 pt-4 shadow-sm backdrop-blur">
        ...
        <div className="mt-3 flex items-center justify-center gap-2 rounded-2xl bg-(--app-gradient-start)/70 px-2 py-2">
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-(--white) text-(--teal-tertiary) shadow-sm transition hover:border-(--teal-primary)/20 hover:text-(--teal-primary)"
            aria-label="بیشتر"
          >
          ...
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-full border border-(--teal-primary)/25 bg-(--teal-primary)/10 text-(--teal-primary) shadow-sm transition"
            aria-label="SMS"
          >
